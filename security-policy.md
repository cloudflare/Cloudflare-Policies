...
CloudFlare is the owner of the information collected on this site and through any CloudFlare service. As visitors browse our web site, or our user's websites if they are protected by CloudFlare, we sometimes log these visitors' interactions in order to provide a better service (e.g., using visitor log data in order to detect new threats). For some examples of the types of information we collect, please see our blog post [here][1].
...
CloudFlare participates in the U.S.-E.U. [Safe Harbor][2] framework and the U.S.-Swiss Safe Harbor as set forth by the United States Department of Commerce. This applies to all personal information received by CloudFlare whether in electronic, paper, or verbal format. As part of our [participation][3] in the Safe Harbor, we have agreed to TRUSTe dispute resolution for disputes relating to our compliance with the Safe Harbor Privacy Framework. If you have any complaints regarding our compliance with the Safe Harbor you should first contact us (as provided below). If contacting us does not resolve your complaint, you may raise your complaint with TRUSTe by [Internet here][4], fax to 415-520-3420, or mail to TRUSTe Safe Harbor Compliance Dept., [click here for mailing address][5]. If you are faxing or mailing TRUSTe to lodge a complaint, you must include the following information: the name of company, the alleged privacy violation, your contact information, and whether you would like the particulars of your complaint shared with the company. For information about TRUSTe or the operation of TRUSTe's dispute resolution process, [click here][6] or request this information from TRUSTe at any of the addresses listed above. The TRUSTe dispute resolution process shall be conducted in English. 
...
### Contact information
 ...
 [1]: http://blog.cloudflare.com/what-cloudflare-logs
 [2]: http://export.gov/safeharbor/
 [3]: https://www.export.gov/safehrbr/list.aspx
 [4]: https://feedback-form.truste.com/watchdog/request
 [5]: http://www.truste.com/about-TRUSTe/contact-us
 [6]: http://www.truste.com/why_TRUSTe_privacy_services/online-privacy-watchdog.html
